...
public class SquareViewPagerIndicator extends View implements ViewPager.OnPageChangeListener{
    ...
    public SquareViewPagerIndicator(Context context){ this(context, null); }

    public SquareViewPagerIndicator(Context context, AttributeSet attrs){ this(context, attrs, 0);}
